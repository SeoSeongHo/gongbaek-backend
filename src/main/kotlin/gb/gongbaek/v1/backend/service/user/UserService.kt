...
interface UserService {
    ...
    fun refresh(oAuthReq: OAuthDto.OAuthReq, userRole: UserRole): OAuthDto.OAuthRes
    ...
    fun updateUserRole(UserRoleReq: UserInfoDto.UserRoleReq, userId: Long): SignInDto.SignInRes
}